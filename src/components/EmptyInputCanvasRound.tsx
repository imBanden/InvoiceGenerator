...
const EmptyInputCanvasRound = ({ height, width }: Props) => {
  ...
  useEffect(() => {
    ...
    function animate() {
      ...
      // gradient.addColorStop(1, "white"); // Outer color of the iris
  ...
  return (
    <>
      <canvas className="crop-circle" ref={canvasRef} />
    </>
  );
};

export default EmptyInputCanvasRound;
